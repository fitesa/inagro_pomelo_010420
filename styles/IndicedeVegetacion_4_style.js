...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.130695 && value <= 0.263883) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.263883 && value <= 0.397070) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.397070 && value <= 0.530257) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.530257 && value <= 0.663445) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.663445 && value <= 0.796632) {
            style = [ new ol.style.Style({
